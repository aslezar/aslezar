...
const Projects = () => {
	...
	return (
		<motion.div className="experience">
			<motion.div className="titleContainer2">
				<p>
			...
			<motion.div className="experienceList" id="style1" ref={ref}>
...
const ExperienceCard = ({
	...
	return (
		<div className="experienceCard">
			...
			<h3>{title}</h3>
			<div className="description2 overflow-y-auto">{description}</div>
...
const Tag = ({ children }) => {
	return <div className="tag2">{children}</div>;
};
